...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>МеталлСтрой - Производство металлоконструкций</title>
        <meta name="description" content="Производство металлоконструкций любой сложности для промышленных и гражданских объектов. Изготовление, проектирование и монтаж." />
      </Helmet>
